...
export const SERVICE: TService[] = [
  {
    ...
    description: `Разрабатываем современные интернет-магазины, которые увеливают продажи минимум на 30% и помогают бизнесу расти.`,
    advantages: ["Продажи", "Интеграция с 1С и CRM", "Удобная оплата для клиентов"],
    url: "/e-commerce",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    advantages: ["Быстрый старт", "Заточен под рекламу"],
    url: "/landing-page",
  },
  {
    id: 4,
    ...
    description: `Сделаем стильные и информативные сайты-визитки для экспертов и блогеров.`,
